...
I am able to signup
 ...
 And Enter firstname "jemmi7" & Lastname "jemmi7" & Email "jemmi7@mailinator.com"
 ...
 And Enter addressline2 "Peachtree"
 And Enter city "Atlanta"
 And Enter zip "31328"
 And Select State
 And Enter username "jemmi7" &password "password1" & confirmpassword "password1"
 And check Terms&condition
 And Check age
 And Check casio key employee checkbox
 And Check all declaration are true
 And hit the Join Pointsbet button
